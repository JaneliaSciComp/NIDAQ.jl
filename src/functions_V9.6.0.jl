...
function DAQmxRegisterEveryNSamplesEvent(task::TaskHandle,everyNsamplesEventType::int32,nSamples::uInt32,options::uInt32,callbackFunction::Cint,callbackData::Ptr{Void})
    ccall((:DAQmxRegisterEveryNSamplesEvent,NIDAQmx),int32,(TaskHandle,int32,uInt32,uInt32,Cint,Ptr{Void}),task,everyNsamplesEventType,nSamples,options,callbackFunction,callbackData)
end

function DAQmxRegisterDoneEvent(task::TaskHandle,options::uInt32,callbackFunction::Cint,callbackData::Ptr{Void})
    ccall((:DAQmxRegisterDoneEvent,NIDAQmx),int32,(TaskHandle,uInt32,Cint,Ptr{Void}),task,options,callbackFunction,callbackData)
end

function DAQmxRegisterSignalEvent(task::TaskHandle,signalID::int32,options::uInt32,callbackFunction::Cint,callbackData::Ptr{Void})
    ccall((:DAQmxRegisterSignalEvent,NIDAQmx),int32,(TaskHandle,int32,uInt32,Cint,Ptr{Void}),task,signalID,options,callbackFunction,callbackData)
end
...
function DAQmxCfgSampClkTiming(taskHandle::TaskHandle,source::Ptr{Uint8},rate::float64,activeEdge::int32,sampleMode::int32,sampsPerChan::Cint)
    ccall((:DAQmxCfgSampClkTiming,NIDAQmx),int32,(TaskHandle,Ptr{Uint8},float64,int32,int32,Cint),taskHandle,source,rate,activeEdge,sampleMode,sampsPerChan)
end

function DAQmxCfgHandshakingTiming(taskHandle::TaskHandle,sampleMode::int32,sampsPerChan::Cint)
    ccall((:DAQmxCfgHandshakingTiming,NIDAQmx),int32,(TaskHandle,int32,Cint),taskHandle,sampleMode,sampsPerChan)
end

function DAQmxCfgBurstHandshakingTimingImportClock(taskHandle::TaskHandle,sampleMode::int32,sampsPerChan::Cint,sampleClkRate::float64,sampleClkSrc::Ptr{Uint8},sampleClkActiveEdge::int32,pauseWhen::int32,readyEventActiveLevel::int32)
    ccall((:DAQmxCfgBurstHandshakingTimingImportClock,NIDAQmx),int32,(TaskHandle,int32,Cint,float64,Ptr{Uint8},int32,int32,int32),taskHandle,sampleMode,sampsPerChan,sampleClkRate,sampleClkSrc,sampleClkActiveEdge,pauseWhen,readyEventActiveLevel)
end

function DAQmxCfgBurstHandshakingTimingExportClock(taskHandle::TaskHandle,sampleMode::int32,sampsPerChan::Cint,sampleClkRate::float64,sampleClkOutpTerm::Ptr{Uint8},sampleClkPulsePolarity::int32,pauseWhen::int32,readyEventActiveLevel::int32)
    ccall((:DAQmxCfgBurstHandshakingTimingExportClock,NIDAQmx),int32,(TaskHandle,int32,Cint,float64,Ptr{Uint8},int32,int32,int32),taskHandle,sampleMode,sampsPerChan,sampleClkRate,sampleClkOutpTerm,sampleClkPulsePolarity,pauseWhen,readyEventActiveLevel)
end

function DAQmxCfgChangeDetectionTiming(taskHandle::TaskHandle,risingEdgeChan::Ptr{Uint8},fallingEdgeChan::Ptr{Uint8},sampleMode::int32,sampsPerChan::Cint)
    ccall((:DAQmxCfgChangeDetectionTiming,NIDAQmx),int32,(TaskHandle,Ptr{Uint8},Ptr{Uint8},int32,Cint),taskHandle,risingEdgeChan,fallingEdgeChan,sampleMode,sampsPerChan)
end

function DAQmxCfgImplicitTiming(taskHandle::TaskHandle,sampleMode::int32,sampsPerChan::Cint)
    ccall((:DAQmxCfgImplicitTiming,NIDAQmx),int32,(TaskHandle,int32,Cint),taskHandle,sampleMode,sampsPerChan)
end

function DAQmxCfgPipelinedSampClkTiming(taskHandle::TaskHandle,source::Ptr{Uint8},rate::float64,activeEdge::int32,sampleMode::int32,sampsPerChan::Cint)
    ccall((:DAQmxCfgPipelinedSampClkTiming,NIDAQmx),int32,(TaskHandle,Ptr{Uint8},float64,int32,int32,Cint),taskHandle,source,rate,activeEdge,sampleMode,sampsPerChan)
end
...
function DAQmxGetReadCurrReadPos(taskHandle::TaskHandle,data::Ptr{Cint})
...
function DAQmxGetLoggingSampsPerFile(taskHandle::TaskHandle,data::Ptr{Cint})
    ccall((:DAQmxGetLoggingSampsPerFile,NIDAQmx),int32,(TaskHandle,Ptr{Cint}),taskHandle,data)
end

function DAQmxSetLoggingSampsPerFile(taskHandle::TaskHandle,data::Cint)
...
function DAQmxGetLoggingFilePreallocationSize(taskHandle::TaskHandle,data::Ptr{Cint})
    ccall((:DAQmxGetLoggingFilePreallocationSize,NIDAQmx),int32,(TaskHandle,Ptr{Cint}),taskHandle,data)
end

function DAQmxSetLoggingFilePreallocationSize(taskHandle::TaskHandle,data::Cint)
...
function DAQmxGetReadTotalSampPerChanAcquired(taskHandle::TaskHandle,data::Ptr{Cint})
...
function DAQmxGetSampQuantSampPerChan(taskHandle::TaskHandle,data::Ptr{Cint})
    ccall((:DAQmxGetSampQuantSampPerChan,NIDAQmx),int32,(TaskHandle,Ptr{Cint}),taskHandle,data)
end

function DAQmxSetSampQuantSampPerChan(taskHandle::TaskHandle,data::Cint)
...
function DAQmxGetWriteCurrWritePos(taskHandle::TaskHandle,data::Ptr{Cint})
...
function DAQmxGetWriteTotalSampPerChanGenerated(taskHandle::TaskHandle,data::Ptr{Cint})
