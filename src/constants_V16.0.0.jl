...
const DAQmx_AI_EddyCurrentProxProbe_SensitivityUnits = 0x02ab
...
const DAQmx_AI_Bridge_Table_PhysicalVals = 0x02f8
...
const DAQmx_AI_Bridge_ShuntCal_GainAdjust = 0x0193
...
const DAQmx_AI_DigFltr_Response = 0x030b
...
const DAQmx_AI_ChanCal_Poly_ForwardCoeff = 0x0229
...
const DAQmx_AI_OpenChanDetectEnable = 0x030f
...
const DAQmx_AO_UsbXferReqSize = 0x02a8
const DAQmx_AO_UsbXferReqCount = 0x3001
const DAQmx_AO_MemMapEnable = 0x0188
...
const DAQmx_CI_Period_DigFltr_TimebaseRate = 0x021e
...
const DAQmx_CI_CountEdges_Gate_TermCfg = 0x030e
...
const DAQmx_CI_DutyCycle_DigFltr_MinPulseWidth = 0x0308
...
const DAQmx_CI_Encoder_AInput_DigSync_Enable = 0x021f
...
const DAQmx_CI_Encoder_ZInputTerm = 0x0219
...
const DAQmx_CI_Velocity_Encoder_AInputLogicLvlBehavior = 0x030d
...
const DAQmx_CI_TwoEdgeSep_First_DigFltr_Enable = 0x0220
...
const DAQmx_CI_SemiPeriod_Units = 0x018a
const DAQmx_CI_SemiPeriod_Term = 0x18b0
const DAQmx_CI_SemiPeriod_TermCfg = 0x030a
...
const DAQmx_CI_Pulse_Time_DigFltr_MinPulseWidth = 0x02f0
...
const DAQmx_CO_RdyForNewVal = 0x022f
const DAQmx_ChanType = 0x0187
...
const DAQmx_Exported_CtrOutEvent_OutputBehavior = 0x0174
...
const DAQmx_Exported_HshkEvent_Interlocked_DeassertDelay = 0x022b
...
const DAQmx_Dev_Accessory_SerialNums = 0x02f6
...
const DAQmx_Dev_AI_SimultaneousSamplingSupported = 0x0298
...
const DAQmx_Dev_AI_LowpassCutoffFreqRangeVals = 0x029c
...
const DAQmx_Dev_AO_PhysicalChans = 0x0231
...
const DAQmx_Dev_CI_MaxSize = 0x0299
...
const DAQmx_Dev_CO_SampModes = 0x02fd
...
const DAQmx_RealTime_WaitForNextSampClkWaitMode = 0x022e
...
const DAQmx_SampClk_DigFltr_MinPulseWidth = 0x0221
...
const DAQmx_AIConv_DigFltr_TimebaseRate = 0x02ed
...
const DAQmx_SyncPulse_MinDelayToStart = 0x0223
...
const DAQmx_AnlgWin_StartTrig_DigFltr_Enable = 0x02ef
...
const DAQmx_StartTrig_Retriggerable = 0x0190
const DAQmx_RefTrig_Type = 0x1419
const DAQmx_RefTrig_PretrigSamples = 0x1445
const DAQmx_RefTrig_Term = 0x02f1
...
const DAQmx_AnlgWin_RefTrig_DigSync_Enable = 0x02ee
...
const DAQmx_DigPattern_PauseTrig_Src = 0x0216
...
const DAQmx_ArmStart_Term = 0x02f7
...
const DAQmx_DigEdge_ArmStartTrig_DigFltr_TimebaseSrc = 0x0222
...
const DAQmx_Watchdog_AO_ExpirState = 0x0305
...
const DAQmx_Write_DigitalLines_BytesPerChan = 0x0217
...
const DAQmx_PhysicalChan_AO_ManualControlAmplitude = 0x02a1
...
const DAQmx_PhysicalChan_TEDS_BitStream = 0x021d
const DAQmx_PhysicalChan_TEDS_TemplateIDs = 0x0228
...
const DAQmxErrorRetryCall = -26853
const DAQmxErrorFileDoesNotExist = -26852
const DAQmxErrorGenerationDisabled = -26851
const DAQmxErrorAlreadyInitialized = -26850
const DAQmxErrorPXISystemDescriptionParseError = -26809
const DAQmxErrorPXISAConfigurationLocked = -26808
const DAQmxErrorNotActiveResourceManager = -26807
const DAQmxErrorInvalidAttribute = -26806
const DAQmxErrorInvalidHandle = -26805
const DAQmxErrorServiceNotRunning = -26804
const DAQmxErrorRecursiveCall = -26803
const DAQmxErrorTimeout = -26802
const DAQmxErrorUnspecifiedError = -26801
const DAQmxErrorHandlerNotFound = -26657
const DAQmxErrorIncorrectDataType = -26656
const DAQmxErrorInconsistentFileFault = -26655
const DAQmxErrorChildNotFound = -26654
const DAQmxErrorAttributeNotFound = -26653
const DAQmxErrorIOError = -26652
const DAQmxErrorPxiResmanMxsPxiSystemNotFound = -26600
const DAQmxErrorPxiResmanPciDescriptionStringParseError = -26550
const DAQmxErrorPxiResmanModuleParseError = -26500
const DAQmxErrorPxiResmanSystemDescriptionSpecLimitation = -26403
const DAQmxErrorPxiResmanSystemDescriptionWriteError = -26402
const DAQmxErrorPxiResmanSystemDescriptionParseError = -26401
const DAQmxErrorPxiResmanSystemDescriptionFileNotFound = -26400
const DAQmxErrorPxiResmanControllerParseError = -26302
const DAQmxErrorPxiResmanControllerTypeInvalid = -26301
const DAQmxErrorPxiResmanControllerFileNotFound = -26300
const DAQmxErrorPxiResmanChassisTriggerParseError = -26206
const DAQmxErrorPxiResmanChassisBridgeParseError = -26205
const DAQmxErrorPxiResmanChassisSlotParseError = -26204
const DAQmxErrorPxiResmanChassisSegmentParseError = -26203
const DAQmxErrorPxiResmanChassisParseError = -26202
const DAQmxErrorPxiResmanChassisBridgeNotFound = -26201
const DAQmxErrorPxiResmanChassisFileNotFound = -26200
const DAQmxErrorInsufficientBuffer = -26113
const DAQmxErrorDirCreateFault = -26112
const DAQmxErrorAccessDenied = -26111
const DAQmxErrorPathNotFound = -26110
const DAQmxErrorFileExists = -26109
const DAQmxErrorFileDeleteFault = -26107
const DAQmxErrorFileCopyFault = -26106
const DAQmxErrorFileCloseFault = -26105
const DAQmxErrorFileNotFound = -26103
const DAQmxErrorPxiResmanSystemNotInitialized = -26102
const DAQmxErrorPxiResmanInvalidConfiguration = -26101
const DAQmxErrorPxiResmanAllocationError = -26100
const DAQmxErrorTrigmanDisconnected = -26010
const DAQmxErrorTrigmanInvalidClient = -26009
const DAQmxErrorTrigmanConflictingRoute = -26008
const DAQmxErrorTrigmanConflictingRouteNoUnreserve = -26007
const DAQmxErrorTrigmanConflictingRouteGeneric = -26006
const DAQmxErrorTrigmanLineAlreadyReserved = -26005
const DAQmxErrorTrigmanLineNotReservedUnroutable = -26004
const DAQmxErrorTrigmanLineNotReserved = -26003
const DAQmxErrorTrigmanInvalidParameter = -26002
const DAQmxErrorTrigmanUnsupportedOper = -26001
const DAQmxErrorTrigmanUnknownError = -26000
const DAQmxWarningTrigmanUnknownError = 26000
const DAQmxWarningTrigmanUnsupportedOper = 26001
const DAQmxWarningTrigmanInvalidParameter = 26002
const DAQmxWarningTrigmanLineNotReserved = 26003
const DAQmxWarningTrigmanLineNotReservedUnroutable = 26004
const DAQmxWarningTrigmanLineAlreadyReserved = 26005
const DAQmxWarningTrigmanConflictingRouteGeneric = 26006
const DAQmxWarningTrigmanConflictingRouteNoUnreserve = 26007
const DAQmxWarningTrigmanConflictingRoute = 26008
const DAQmxWarningTrigmanInvalidClient = 26009
const DAQmxWarningTrigmanDisconnected = 26010
const DAQmxWarningPxiResmanAllocationError = 26100
const DAQmxWarningPxiResmanInvalidConfiguration = 26101
const DAQmxWarningPxiResmanSystemNotInitialized = 26102
const DAQmxWarningFileNotFound = 26103
const DAQmxWarningFileCloseFault = 26105
const DAQmxWarningFileCopyFault = 26106
const DAQmxWarningFileDeleteFault = 26107
const DAQmxWarningFileExists = 26109
const DAQmxWarningPathNotFound = 26110
const DAQmxWarningAccessDenied = 26111
const DAQmxWarningDirCreateFault = 26112
const DAQmxWarningInsufficientBuffer = 26113
const DAQmxWarningPxiResmanChassisFileNotFound = 26200
const DAQmxWarningPxiResmanChassisBridgeNotFound = 26201
const DAQmxWarningPxiResmanChassisParseError = 26202
const DAQmxWarningPxiResmanChassisSegmentParseError = 26203
const DAQmxWarningPxiResmanChassisSlotParseError = 26204
const DAQmxWarningPxiResmanChassisBridgeParseError = 26205
const DAQmxWarningPxiResmanChassisTriggerParseError = 26206
const DAQmxWarningPxiResmanControllerFileNotFound = 26300
const DAQmxWarningPxiResmanControllerTypeInvalid = 26301
const DAQmxWarningPxiResmanControllerParseError = 26302
const DAQmxWarningPxiResmanSystemDescriptionFileNotFound = 26400
const DAQmxWarningPxiResmanSystemDescriptionParseError = 26401
const DAQmxWarningPxiResmanSystemDescriptionWriteError = 26402
const DAQmxWarningPxiResmanSystemDescriptionSpecLimitation = 26403
const DAQmxWarningPxiResmanModuleParseError = 26500
const DAQmxWarningPxiResmanPciDescriptionStringParseError = 26550
const DAQmxWarningPxiResmanMxsPxiSystemNotFound = 26600
const DAQmxWarningIOError = 26652
const DAQmxWarningAttributeNotFound = 26653
const DAQmxWarningChildNotFound = 26654
const DAQmxWarningInconsistentFileFault = 26655
const DAQmxWarningIncorrectDataType = 26656
const DAQmxWarningHandlerNotFound = 26657
const DAQmxWarningUnspecifiedError = 26801
const DAQmxWarningTimeout = 26802
const DAQmxWarningRecursiveCall = 26803
const DAQmxWarningServiceNotRunning = 26804
const DAQmxWarningInvalidHandle = 26805
const DAQmxWarningInvalidAttribute = 26806
const DAQmxWarningNotActiveResourceManager = 26807
const DAQmxWarningPXISAConfigurationLocked = 26808
const DAQmxWarningPXISystemDescriptionParseError = 26809
const DAQmxWarningAlreadyInitialized = 26850
const DAQmxWarningGenerationDisabled = 26851
const DAQmxWarningFileDoesNotExist = 26852
const DAQmxWarningRetryCall = 26853
